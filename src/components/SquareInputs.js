        ...
        <div>
            <form className="form" onSubmit={onCalculate}> 
                ...
                <svg id="shape-display" viewBox="1.5 0 40 40" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <text id="line-text" x="-6.5" y="20" style={{fontSize: "3px", textAnchor: "end"}}>{length}</text>
                    <line id="lines" x1="-3.5" y1="35" x2="31.5" y2="35" stroke={focus ? "#363636" : "#575757"} />
                    <line id="lines" x1="-3" y1="4" x2="-3" y2="35.5" stroke={focus ? "#0061e0" : "#575757"} />
                    <line id="lines" x1="31" y1="4" x2="31" y2="35" stroke={focus ? "#363636" : "#575757"} />
